        ...
        <div className="max-w-6xl px-6 py-10 mx-auto space-y-8">
            <div className="px-4 h-16 rounded-xl bg-zinc-900 shadow-shape flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-zinc-100">Itacaré, Brasil</span>
                </div>
                ...
                <div className="w-80 space-y-6">
                        ...
                        <div className="space-y-5">
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <a href="#" className="block font-medium text-zinc-400 truncate hover:text-zinc-200">https://www.airbnb.com.br/rooms/6765834652657346538745637856397</a>
                                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-5">
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    <span className="block font-medium text-zinc-100">Kyra Gracie</span>
                                    <span className="block text-sm text-zinc-400 truncate">
                                        kyra.gracie@gmail.com
                                    </span>
                                </div>
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    <span className="block font-medium text-zinc-100">Anderson Silva</span>
                                    <span className="block text-sm text-zinc-400 truncate">
                                        anderson@spider.com
                                    </span>
                                </div>
